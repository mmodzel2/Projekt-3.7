...
int main()
{
    ...
    cout << n4->get_node() << endl;
    Voltage_source<double>* r1 = new Voltage_source<double>(5);
    Resistor<double>* r2 = new Resistor<double>(1);
    Resistor<double>* r3 = new Resistor<double>(6);
    Resistor<double>* r4 = new Resistor<double>(1);
    Resistor<double>* r5 = new Resistor<double>(2);
    Resistor<double>* r6 = new Resistor<double>(2);
    Voltage_disource<double>* r7 = new Voltage_disource<double>(4, "U2.3");
    //Capacitity<double>* r7 = new Capacitity<double>(4);
    //Inductance<double>* r7 = new Inductance<double>(4);
